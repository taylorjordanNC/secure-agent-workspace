...
DASHBOARD_UI_FORWARD_SANDBOX="{{ with .Values.dashboard.uiForward }}{{ .sandbox | default "" }}{{ end }}"
DASHBOARD_UI_FORWARD_WORKSPACE="{{ with .Values.dashboard.uiForward }}{{ .workspace | default "" }}{{ end }}"
